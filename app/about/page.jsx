      ...
      <section className="relative h-screen overflow-hidden">
        <div className="absolute inset-0">
          <div
            ...
            style={{ backgroundImage: "url('https://res.cloudinary.com/dtbforfvb/image/upload/v1746533950/customerservice_f3nr7u.jpg')" }}
          />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col justify-center text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6 text-white">Ismael Dayo</h1>
          ...
          <div className="flex justify-center space-x-4 mt-6">
            ...
            <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="text-white hover:text-indigo-200 transition-colors">
              <FaTwitter size={24} />
            </a>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 h-40 w-40 rounded-full overflow-hidden border-4 border-white shadow-lg">
                <Image 
                  src="https://res.cloudinary.com/dtbforfvb/image/upload/v1746545783/author-name_jygqik.jpg"
                  alt="Ismael Dayo portrait"
                  fill
                  sizes="160px"
                  className="object-cover"
                />
            ...
            <div className="md:pl-10">
              ...
              <p className="text-lg text-gray-700 mb-4">
                Hello! I'm Ismael Dayo, a passionate fullstack developer with over 8 years of experience building web and mobile applications.
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {awards.map((award, index) => (
              <div key={index} className="bg-white p-6 rounded-lg shadow-md border-t-4 border-slate-500 hover:shadow-lg transition-shadow">
                <div className="flex items-center mb-4">
                  <FaAward size={24} className="text-slate-600 mr-3" />
