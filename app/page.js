            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div className="order-2 md:order-1">
                  ...
                  <h2 className="text-3xl font-bold mb-2">How have you been?</h2>
                  <h1 className="text-5xl md:text-6xl font-extrabold mb-6 leading-tight">I&apos;m Ismael Dayo</h1>
                  <p className="text-xl mb-8 leading-relaxed" data-aos="flip-left">
                    Full-Stack Developer with a passion for crafting innovative solutions and thriving in collaborative team environments.
                    Proficient in PHP frameworks like Laravel and Flask to build robust backend systems that power seamless,
                    user-friendly web experiences. Specialized in African market solutions with M-Pesa integration expertise.
                  </p>
                ...
                <div className="flex justify-center order-1 md:order-2">
                  <div className="relative w-80 h-80 md:w-96 md:h-96">
                    <div className="absolute w-full h-full rounded-full border-4 border-white/50 shadow-2xl overflow-hidden">
                      <Image
                    ...
                    <div className="absolute -bottom-2 -right-2 bg-white text-slate-600 rounded-full p-4 shadow-lg">
                      <Image 
                        src="https://res.cloudinary.com/dtbforfvb/image/upload/v1743313868/Dayo_a2c05m.jpg"
                        alt="Developer"
                        width={50}
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                <div className="relative">
                  <Image
                    src="https://res.cloudinary.com/dtbforfvb/image/upload/v1745501392/Fahima.png_gngahk.jpg"
                    alt="Ismael at work"
                    width={500}
                    height={500}
                ...
                <div>
                  <h2 className="text-2xl font-thin text-slate-500 mb-6 tracking-tight uppercase">About Me</h2>
                  ...
                  <p className="text-lg text-gray-700 mb-8 leading-relaxed">
                    My journey began with a Bachelor&apos;s degree in Computer Enginerring from Obafemi Awolowo University Ile-Ife, and Master&apos;s degree from University of Lagos followed by specialized
                    training in System Engineering and mobile development form the same University. I specialize in creating solutions that address uniquely African challenges,
                ...
                <div>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="mt-1 text-gray-600">ismaiheel4real2008@gmail.com</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="mt-1 text-gray-600">+234 803 123 4567</p>
                      </div>
                    </div>
                  ...
                  <div className="mt-10">
                    ...
                    <div className="flex space-x-4">
                      <Link href="https://www.linkedin.com/in/ismaiheel-dayo-00180b1a1/" target="_blank" className="bg-slate-100 p-3 rounded-full hover:bg-slate-200 transition">
                        <FaLinkedin size={20} className="text-slate-600" />
                      </Link>
                      <Link href="https://x.com/Salaudeenismai7" target="_blank" className="bg-slate-100 p-3 rounded-full hover:bg-slate-200 transition">
                        <FaXTwitter size={20} className="text-slate-600" />
                      </Link>
                      <Link href="https://web.facebook.com/salaudeenismaiheel.dayo" target="_blank" className="bg-slate-100 p-3 rounded-full hover:bg-slate-200 transition">
                        <FaFacebook size={20} className="text-slate-600" />
                      </Link>
                      <Link href="https://www.tiktok.com/@ismaeldayo" target="_blank" className="bg-slate-100 p-3 rounded-full hover:bg-slate-200 transition">
          ...
          <footer className="bg-slate-800 text-white py-16">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div>
                  <h3 className="text-2xl font-bold mb-4">Ismael Dayo</h3>
                  <p className="text-gray-300 mb-4">
                    Full-Stack Developer specializing in African market solutions and M-Pesa integration.
                  </p>
                  <div className="flex space-x-4">
                    <Link href="https://www.linkedin.com/in/ismaiheel-dayo-00180b1a1/" target="_blank" className="text-gray-300 hover:text-white">
                      <FaLinkedin size={20} />
                    </Link>
                    <Link href="https://x.com/Salaudeenismai7" target="_blank" className="text-gray-300 hover:text-white">
                      <FaXTwitter size={20} />
                    </Link>
                    <Link href="https://web.facebook.com/salaudeenismaiheel.dayo" target="_blank" className="text-gray-300 hover:text-white">
                      <FaFacebook size={20} />
                    </Link>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      ...
                      <span className="text-gray-300">ismaeldayo@gmail.com</span>
                    </li>
                    <li className="flex items-start">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 mt-0.5 text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                      </svg>
                      <span className="text-gray-300">+234-(80)- 3215-9449</span>
                    </li>
                    <li className="flex items-start">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 mt-0.5 text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
