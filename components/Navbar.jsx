        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center">
            <Link href="/" className="flex-shrink-0 flex items-center" data-aos="fade-right">
              <span className="text-2xl font-bold text-indigo-600">DY</span>
              <span className="ml-1 text-2xl text-amber-500 hidden sm:block">Ismael Dayo</span>
            </Link>
          </div>
          ...
          <div className="hidden md:flex md:items-center md:space-x-8">
            <Link href="/" className="text-gray-700 hover:text-slate-500 font-medium">Home</Link>
            <Link href="/about" className="text-gray-700 hover:text-slate-500 font-medium">About</Link>
            <Link href="/skills" className="text-gray-700 hover:text-slate-500 font-medium">Skills</Link>
            ...
            <div className="relative" ref={projectsRef}>
              <button
                ...
                className="text-gray-700 hover:text-gray-400 font-medium flex items-center"
              >
                Projects
            ...
            <div className="relative" ref={featuresRef}>
              <button
                ...
                className="text-gray-700 hover:text-slate-500 font-medium flex items-center"
              >
                Features
            ...
            <Link href="/contact" className="text-gray-700 hover:text-slate-900 font-medium">Contact</Link>
